...
public class DocQuery {
    ...
    public static void querydoc(Connection con){
     ...
     a3=0;
       ...
       scene.getStylesheets().add(DocQuery.class.getResource("css/style.css").toExternalForm());
        scene.getStylesheets().add(DocQuery.class.getResource("css/animated.css").toExternalForm());
        root.setId("paneq");
...
"FROM DOCTOR_NURSE_OFFICER";
    ...
    public static void query5(String sql) {
        try {
            ...
            BorderPane root= new BorderPane();
            Scene scene = new Scene(root, 1100, 900);
            scene.getStylesheets().add(DocQuery.class.getResource("css/backgrounds.css").toExternalForm());
            scene.getStylesheets().add(DocQuery.class.getResource("css/css1.css").toExternalForm());
