...
import refugee_reg_db_mg.refugeeQuery;
import refugee_reg_db_mg.volunteer;
import refugee_reg_db_mg.instituteQuery;
import refugee_reg_db_mg.EduQuery;
import refugee_reg_db_mg.DocQuery;
import refugee_reg_db_mg.ComplaintQuery;
import refugee_reg_db_mg.DiagnosisQuery;
...
public class queryFunctions {
    ...
    public static void selectTable() {
        primaryStage = Main.primaryStage;
            ...
            scene1.getStylesheets().add(queryFunctions.class.getResource("css/css1.css").toExternalForm());
    ...
    public static void showRes(String sql) {
        try {
            ...
            scene.getStylesheets().add(queryFunctions.class.getResource("css/css1.css").toExternalForm());
