...
public class refugeeQuery {
    ...
    public static void query1() {
        ...
        grid.add(next, 0, 7);
        scene.getStylesheets().add(refugeeQuery.class.getResource("css/style.css").toExternalForm());
        scene.getStylesheets().add(refugeeQuery.class.getResource("css/animated.css").toExternalForm());
        root.setId("paneq");
        root.setCenter(grid);
    ...
    public static void query4() {
        ...
        root = new BorderPane();
        scene = new Scene(root, 1100,900);
        scene.getStylesheets().add(refugeeQuery.class.getResource("css/backgrounds.css").toExternalForm());
            scene.getStylesheets().add(refugeeQuery.class.getResource("css/css1.css").toExternalForm());
    ...
    public static void querydetails(String idref,String sql1) {
        try{
            ...
            scene.getStylesheets().add(refugeeQuery.class.getResource("css/backgrounds.css").toExternalForm());
            scene.getStylesheets().add(refugeeQuery.class.getResource("css/css1.css").toExternalForm());
            scene.getStylesheets().add(refugeeQuery.class.getResource("css/scroll1.css").toExternalForm());
            root.setId("background-three");
            grid.setAlignment(Pos.CENTER);
            grid.setPadding(new Insets(25, 25, 25, 25));
