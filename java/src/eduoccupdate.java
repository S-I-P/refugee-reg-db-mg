...
public class eduoccupdate {
    ...
    public static void update() {
        ...
        scene.getStylesheets().add(eduoccupdate.class.getResource("css/css1.css").toExternalForm());
        scene.getStylesheets().add(eduoccupdate.class.getResource("css/backgrounds.css").toExternalForm());
        scene.getStylesheets().add(eduoccupdate.class.getResource("css/fonts.css").toExternalForm());
