...
import refugee_reg_db_mg.imagedrag;
...
public class DocNurseTable {
    ...
    public static void docnurse(Connection con) {
        ...
        scene.getStylesheets().add(DocNurseTable.class.getResource("css/backgrounds.css").toExternalForm());
        scene.getStylesheets().add(DocNurseTable.class.getResource("css/animated.css").toExternalForm());
        scene.getStylesheets().add(DocNurseTable.class.getResource("css/css1.css").toExternalForm());
