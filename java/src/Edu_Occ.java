...
public class Edu_Occ {
    ...
    public static void insert1(String r) {
        ...
        scene.getStylesheets().add(Edu_Occ.class.getResource("css/css1.css").toExternalForm());
        scene.getStylesheets().add(Edu_Occ.class.getResource("css/backgrounds.css").toExternalForm());
        scene.getStylesheets().add(Edu_Occ.class.getResource("css/fonts.css").toExternalForm());
