...
public class complaint {
    ...
    public static void insert1() {
        ...
        scene.getStylesheets().add(complaint.class.getResource("css/css1.css").toExternalForm());
        scene.getStylesheets().add(complaint.class.getResource("css/backgrounds.css").toExternalForm());
        scene.getStylesheets().add(complaint.class.getResource("css/fonts.css").toExternalForm());
