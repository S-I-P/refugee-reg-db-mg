...
public class volunteer {
    ...
    public static void insert1() {
        ...
        scene.getStylesheets().add(volunteer.class.getResource("css/css1.css").toExternalForm());
        grid.setHgap(5);
        grid.setVgap(20);
    ...
    public static void query1() {
        ...
        root = new BorderPane();
        scene = new Scene(root, 1100,900);
        scene.getStylesheets().add(volunteer.class.getResource("css/style.css").toExternalForm());
        scene.getStylesheets().add(volunteer.class.getResource("css/animated.css").toExternalForm());
        root.setId("paneq");
        grid.setAlignment(Pos.CENTER);
        grid.setPadding(new Insets(25, 25, 25, 25));
        grid.setHgap(5);
